...
const [workProps,setWorkProp]=React.useState(
    {
        ...
        workDescription: { first: 'This website is an e-commerce website developed using React. The website was developed for blueberries ice cream shop in Nazareth.', 
                           ...
                           third:'This project represents my resume.',
